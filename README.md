...
- [系统安装](system-installation.md/#系统安装)
  ...
  - [2. 连接网络](system-installation.md/#2-连接网络)
    - [2.1 无线网络](system-installation.md/#21-无线网络)
      - [2.1.1 扫描当前互联网设备](system-installation.md/#21-扫描当前互联网设备)
      - [2.1.2 启用设备](system-installation.md/#22-启用设备)
      - [2.1.3 扫描当前设备下的WiFi列表并得到所有WiFi的名字](system-installation.md/#23-扫描当前设备下的wifi列表并得到所有wifi的名字)
      - [2.1.4 使用`wpa_supplicant`连接网络并后台运行](system-installation.md/#24-使用wpasupplicant连接网络并后台运行)
      - [2.1.5 动态分配IP地址](system-installation.md/#25-动态分配ip地址)
    - [2.2 有线网络](system-installation.md/#22-有线网络)
      - [2.2.1 启用设备](system-installation.md/#221-启用设备)
      - [2.2.2 动态分配IP地址](system-installation.md/#222-动态分配IP地址)
    - [2.3 测试](system-installation.md/#26-测试)
